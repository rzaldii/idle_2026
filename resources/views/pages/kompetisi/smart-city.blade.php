...
<style>
    /* =========================================================
       Scoped Styling for Smart City Page — IDLE 2026 Retro Arcade Theme
       ========================================================= */
    body {
        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-lg-7 cpc-animate-hero-left">
                    <h1 class="cpc-title">
                        Kompetisi <span class="text-neon-cyan">Smart City</span>
                    </h1>

                    <p class="cpc-subtitle">
                        Eksplorasi pemanfaatan data dan teknologi cerdas untuk pengelolaan kota yang efisien, responsif, serta melayani kebutuhan masyarakat modern.
                    </p>
                    ...
                    <div class="cpc-actions">
                        ...
                        <a href="https://drive.google.com/drive/folders/1BbOkJMaZHTNMT_gg5sreGPuIAucoLL8k?usp=drive_link" target="_blank" rel="noopener noreferrer" class="btn-idle-secondary">
                            <i class="fa fa-file-pdf-o" style="margin-right: 8px;"></i> Unduh Rule Book
                        </a>
                        <a href="https://docs.google.com/document/d/1oGYlHneLF4kaxm-cH6tkhU3WDfY-SSPaK13DWT4nM4k/edit?usp=sharing" target="_blank" rel="noopener noreferrer" class="btn-idle-outline-magenta">
