...
<style>
    /* =========================================================
       Scoped Styling for PPL Page — IDLE 2026 Retro Arcade Theme
       ========================================================= */
    body {
        ...
        <div class="container position-relative">
            <div class="row align-items-center">
                <div class="col-lg-7 cpc-animate-hero-left">
                    <h1 class="cpc-title">
                        Kompetisi <span class="text-neon-cyan">Pengembangan Perangkat Lunak</span> (PPL)
                    </h1>

                    <p class="cpc-subtitle">
                        Ajang inovasi pengembangan aplikasi perangkat lunak (software) yang kreatif, solutif, dan aplikatif untuk menjawab berbagai tantangan nyata masyarakat secara berkelanjutan.
                    </p>
                    ...
                    <div class="cpc-actions">
                        ...
                        <a href="https://drive.google.com/drive/folders/1vpwfPjS0r-jGSwOechkYYkf1DrFZKryH?usp=drive_link" target="_blank" rel="noopener noreferrer" class="btn-idle-secondary">
                            <i class="fa fa-file-pdf-o" style="margin-right: 8px;"></i> Unduh Rule Book
                        </a>
                        <a href="https://docs.google.com/document/d/13n5HiZtK20OSgI2b6icrNgNPkg1aRnvbc32TqH-_QUM/edit?usp=sharing" target="_blank" rel="noopener noreferrer" class="btn-idle-outline-magenta">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        ...
                        <p style="color: var(--color-text-secondary); line-height: 1.75; font-size: 0.95rem; text-align: justify;">
                            <strong>Pengembangan Perangkat Lunak (PPL) IDLE 2026</strong> merupakan salah satu bidang ajang kompetisi ISIC 2026 yang bertujuan mendorong peserta untuk menghasilkan karya inovatif berupa perangkat lunak yang kreatif, aplikatif, dan berdampak nyata bagi masyarakat.
                        </p>

                        <p style="color: var(--color-text-secondary); line-height: 1.75; font-size: 0.95rem; text-align: justify; margin-bottom: 0;">
                            Peserta diberikan kebebasan untuk memilih platform pengembangan yang sesuai, sehingga dapat mengeksplorasi potensi teknologi terkini melalui kolaborasi yang solid demi menciptakan produk yang inovatif, bermanfaat, dan menjawab kebutuhan nyata secara berkelanjutan.
                        </p>
                    </div>
                </div>
            </div>
