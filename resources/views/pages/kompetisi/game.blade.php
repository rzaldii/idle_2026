...
@section('title', 'IDLe 2026 — Kompetisi Game Development')

@section('css')
<link rel="stylesheet" href="{{ asset('assets/css/idle-design-system.css') }}">
<style>
    /* =========================================================
       Scoped Styling for Game Dev Page — IDLE 2026 Retro Arcade Theme
       ========================================================= */
    body {
            ...
            <div class="row align-items-center">
                <div class="col-lg-7">
                    <h1 class="kompetisi-title">
                        Kompetisi <span class="text-neon-cyan">Game Development</span> (ITeC 2026)
                    </h1>

                    <p class="kompetisi-subtitle">
                        Kembangkan karya permainan digital orisinal yang memadukan gameplay menarik, mekanik interaktif, dan estetika visual audio untuk menghadirkan pengalaman bermain bernilai edukatif dan berdampak positif.
                    </p>
                    ...
                    <div class="kompetisi-actions">
                        ...
                        <a href="https://docs.google.com/document/d/17AaVjf9tJ0-c6EPxWV711TMj2jqtFK87jg6MJGAVyYA/edit?usp=sharing" target="_blank" class="btn-idle-outline">
                ...
                <div class="col-lg-5 mt-4 mt-lg-0 text-center">
                    <div class="kompetisi-poster-box mx-auto" style="max-width: 460px;">
                        <img class="kompetisi-poster-img" 
                             src="{{ asset('assets/img/kategori/gamedev.jpg') }}" 
                             alt="Poster {{ $kategori->nama_kategori }}"
                             onerror="this.onerror=null; this.src='{{ asset('assets/img/kategori/game.jpg') }}'">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <h2 class="font-display font-weight-bold mb-3" style="color: var(--color-text-primary); font-size: 1.75rem;">
                            Tentang Game Development ITeC 2026
                        </h2>

                        <p style="color: var(--color-text-secondary); line-height: 1.75; font-size: 0.95rem; text-align: justify;">
                            Game Development ITeC 2026 merupakan cabang kompetisi perancangan dan pembangunan permainan digital interaktif yang menggabungkan unsur hiburan, edukasi, dan nilai positif. Kompetisi ini mendorong peserta untuk mengangkat isu yang relevan dengan Sustainable Development Goals (SDGs) melalui pengalaman bermain yang menarik dan bermakna, sejalan dengan tema utama “Digital Innovation for Smart Society: Empowering Sustainable, Inclusive, and Impactful Technology”.
                        </p>

                        <p style="color: var(--color-text-secondary); line-height: 1.75; font-size: 0.95rem; text-align: justify; margin-bottom: 0;">
                            Peserta ditantang untuk mengembangkan permainan interaktif yang tidak hanya memberikan pengalaman hiburan, tetapi juga mampu menyampaikan pesan dan meningkatkan kesadaran terhadap isu yang diangkat. Karya yang dikembangkan akan dipresentasikan pada babak final untuk menjelaskan konsep permainan, pesan yang disampaikan, serta keterkaitannya dengan isu SDGs.
                        </p>
                    </div>
                </div>
            </div>
