           ...
           <div class="row">
               ...
               <div class="col-auto col-md-6">
                   <p class="text-justify">
                     Kompetisi Bisnis TIK merupakan kompetisi pengembangan model bisnis berbasis produk TIK. Lomba ini akan menyeleksi ide pengembangan bisnis dalam bentuk Pitchdeck dan tahapan implementasi awal. Melalui penerapan metodologi Lean startup mulai dari Problem-solution fit hingga Product-market fit (desirable, viable, feasible), peserta diberikan kesempatan untuk mengembangkan ide bisnis startup maupun usaha rintisan berbasis TIK. Kompetisi ini menekankan pada sejauh mana ide tersebut memberikan dampak nyata terhadap stakeholder serta menghadirkan solusi inovatif yang relevan dengan kebutuhan masyarakat. Arah pengembangan bisnis juga berfokus pada semangat social entrepreneurship yang mengedepankan value proposition of the community, sehingga mahasiswa dapat mengasah kreativitas dan keterampilan bisnis dalam menciptakan solusi inovatif berkelanjutan yang mendukung kemandirian bangsa.
                   </p>
                   <a class="btn btn-success shadow" href="https://drive.google.com/drive/folders/1Uccvclh1r9GvRnvk897CZS-0ARA48sMs?usp=drive_link" target="_blank" rel="noopener noreferrer">Rule Book</a>
                   <a class="btn btn-success shadow" href="https://docs.google.com/document/d/1xLMcZkWU5kEWPy-LzQX0yJVPq8Sg4AJz3dTgwzhpim8/edit?usp=sharing" target="_blank" rel="noopener noreferrer">Template</a>
